    ...
    try:
        ...
        try:
            ...
            try:
                ...
                result = DeepFace.analyze(img, actions=["emotion"], enforce_detection=True)[0]
                logger.info("Face detected successfully with enforce_detection=True")
            except Exception as face_error:
                logger.warning(f"Face detection failed: {str(face_error)}, trying with enforce_detection=False")
                ...
                if result.get("face_confidence", 0) == 0:
                    logger.warning("Low face confidence detected, results may be inaccurate")
                    ...
                    if result["dominant_emotion"] == "fear" and result["emotion"]["fear"] > 99.9:
                        ...
                        logger.info("Using more varied emotion distribution instead of 100% fear")
